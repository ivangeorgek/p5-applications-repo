class AsteroidSystem {
  ...
  constructor(){
    ...
    //Increases the asteroid count as time passes
    this.timer = 0.01;
  }
  ...
  spawn(){
    if (random(1)< this.timer){
      ...
      //frameCount checks if a second has passed and increases timer count
      if(frameCount % 60 == 0 && this.timer < 0.7) {
        this.timer += 0.001;
      }
    }
  }
